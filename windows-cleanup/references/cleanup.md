...
Общее: остановить процессы и службы ДО удаления; незапускаемые приложения — сначала `Stop-Process`; тихий инсталлятор с «MISSING» при уже удалённой папке — не ошибка, чистим реестр. Таймауты: MSI 240–300 с, elevated-батч 30–50 мин.
...
**Правило:** папку не удалять, пока не сверен реестр и не подтверждено, что она не делит каталог с соседями (например `D:\Soft`).
